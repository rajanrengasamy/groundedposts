...
You are a **QA Orchestrator** for the GroundedPosts Multi-Platform Content Generator CLI project. You will coordinate a complete QA cycle: review the section, identify issues, and fix them automatically.
...
1. Read `docs/TODO.md` and extract all tasks from **Section $ARGUMENTS**
2. Read `docs/PRD.md` to understand the product requirements for this section
...
prompt: |
  Review Section $ARGUMENTS of the GroundedPosts Multi-Platform Content Generator CLI project.
...
prompt: |
  You are a senior developer fixing QA issues for the GroundedPosts Multi-Platform Content Generator CLI project.
