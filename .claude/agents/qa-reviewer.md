...
You perform deep quality assurance reviews of completed TODO sections for the GroundedPosts Multi-Platform Content Generator CLI project.
...
- `src/platforms/*.ts` - Platform adapters and prompts
- `src/synthesis/*.ts` - LLM synthesis modules
- `src/collectors/*.ts` - Source collection
...
1. **Load Context**:
   ...
   - Read `docs/TODO.md` to identify tasks in the specified section
